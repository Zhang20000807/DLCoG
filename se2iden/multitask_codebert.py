...
def load_data(json_file):
    snippet1, snippet2, labels1, labels2 = [], [], [], []
    with open(json_file, 'r') as fin:
        for line in fin:
            data = json.loads(line)
            snippet1.append(data["snippet1"])
            snippet2.append(data["snippet2"])
            labels1.append(data["Label1"])
            labels2.append(data["Label2"])

    return snippet1, snippet2, labels1, labels2
...
# Load data
comments, snippets, labels1, labels2 = load_data('')
